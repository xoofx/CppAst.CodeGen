# CppAst.CodeGen — Codex Agent Instructions
...
- Library: `src/CppAst.CodeGen/`
- Tests: `src/CppAst.CodeGen.Tests/` (MSTest)
...
- The source of the package CppAst might be locally check out at `../CppAst/src/CppAst` in case there is a need to access the sourcecode.